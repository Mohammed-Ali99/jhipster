...
function connect(event) {
  ...
  if (nickname && fullname) {
    ...
    // Include the JWT token in the connection headers
    const jwtToken =
      'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTczNTQwMjUyNSwiYXV0aCI6IlJPTEVfQURNSU4gUk9MRV9VU0VSIiwiaWF0IjoxNzM1MzE2MTI1fQ.wyj4PKt5vRjYe51RIFsrqjtFCv-8hYuSgHGgkWydsLp51OwXnUZn4HiOgoXaIbtyOyifinkb84W1pwDn8lvq8Q';
    const headers = {
